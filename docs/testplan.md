...
|----------|-----------|-----|
| Venv loomine ja sõltuvuste paigaldus | Anton | 5 min |
| Serveri käivitamine ja `/status` testimine | Anton | 2 min |
Anton| Vigade käsitlemise test | Anton | 10 min |
...
| Tegevus | Vastutaja | Aeg |
|----------|---------------|-------|
| Sündmuste testimine (`variant_vaade`, `variant_vahetus`) | Anton | 10 min |
| Network-paneeli ja DebugView kontrollimine | Anton | 5 min |
| Ekraanipiltide kogumine ja aruande koostamine | Anton | 5 min |
...
| Pytest käivitamine + logi salvestamine | Anton | 5 min |
...
|----------|---------------|-------|
| Testide kirjutamine | Anton | 10 -15 min |
| Npm testi käivitamine + logi salvestamine | Anton | 5 min |
